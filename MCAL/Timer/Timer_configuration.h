...
/* compare output mode Description
   Options:
		...
		3: ClearOnCompare_SetAtTop    -    Clear OC0 on compare match, set OC0 at TOP
		4: SetAtCompare_ClearOnTop			- Set OC0 on compare match, clear OC0 at TOP
 */
...
/* Clock Select - Prescaler
   Options: 
		1: Timer0No_Prescalig       -   Clock Source
		2: Timer0Div_By_8           -   Division by 8
		3: Timer0Div_By_64          -   Division by 64
		4: Timer0Div_By_256         -   Division by 256
		5: Timer0Div_By_1024        -   Dvision by 1024
 */
...
#define Timer1Waveform_Mode     CTC_OCR1A_TOP
...
#define Timer1Prescaler_Select       TimerDiv_By_256
 ...
 */
#define Timer1_ChannelACTCInterrupt         Timer1_ChannelACTCEnableInterrupt
...
#define Timer1_CompareAValue                    31250
